...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "GroupService/elevated_users.json")
...
*Global Blue Text*
 ❍ /gignoreblue*:* <word>*:* Globally ignore bluetext cleaning of saved word across Ritikraj Service.
