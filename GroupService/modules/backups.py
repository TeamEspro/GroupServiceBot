...
# from GroupService.modules.sql import warns_sql as warnssql
import GroupService.modules.sql.blacklist_sql as blacklistsql

# from GroupService.modules.sql import cust_filters_sql as filtersql
# import GroupService.modules.sql.welcome_sql as welcsql
import GroupService.modules.sql.locks_sql as locksql
import GroupService.modules.sql.notes_sql as sql

# from GroupService.modules.rules import get_rules
import GroupService.modules.sql.rules_sql as rulessql
from GroupService import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from GroupService.__main__ import DATA_IMPORT
from GroupService.modules.connection import connected
from GroupService.modules.helper_funcs.alternate import typing_action
from GroupService.modules.helper_funcs.chat_status import user_admin
from GroupService.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("GroupService{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("GroupService{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `GroupService-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("GroupService{}.backup".format(chat_id))  # Cleaning file
